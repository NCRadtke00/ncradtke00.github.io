...
const skillsSection = {
  ...
  devskills: [
    ...
    { skillType: "front", skillName: "Redux", fontAwesomeClassname: "" },
    { skillType: "front", skillName: "Razor Pages", fontAwesomeClassname: "" },
    { skillType: "front", skillName: "Tailwind", fontAwesomeClassname: "" },
    {
      skillType: "front",
      skillName: "Styled-Components",
      fontAwesomeClassname: "",
    },
    { skillType: "front", skillName: "TypeScript", fontAwesomeClassname: "" },
    { skillType: "front", skillName: "Bootstrap", fontAwesomeClassname: "" },
    {
      skillType: "back",
      skillName: "Node.js",
    ...
    { skillType: "back", skillName: "Asp.Net", fontAwesomeClassname: "" },
    { skillType: "back", skillName: " C# ", fontAwesomeClassname: "" },
    {
      skillType: "other",
      skillName: "SQL",
    ...
    { skillType: "other", skillName: "AdobeXD", fontAwesomeClassname: "" },
  ],
  display: true,
};
const educationInfo = {
